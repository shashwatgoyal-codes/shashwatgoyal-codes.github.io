...
(function(){
  ...
  var dock=document.getElementById("dock");if(dock){var links={};[].forEach.call(dock.querySelectorAll("a[data-dock]"),function(a){links[a.getAttribute("href")]=a;});var secs=["top","skills","work","project","connect","contact"].map(function(id){return document.getElementById(id);}).filter(Boolean);var spy=new IntersectionObserver(function(es){es.forEach(function(e){if(!e.isIntersecting)return;for(var k in links)links[k].classList.remove("active");var l=links["#"+e.target.id];if(l)l.classList.add("active");});},{rootMargin:"-45% 0px -45% 0px"});secs.forEach(function(x){spy.observe(x);});}
